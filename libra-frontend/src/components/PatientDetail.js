...
class PatientDetail extends Component{
    ...
    render()
    {
        ...
        return(
            ...
            <Card title={"Patient Name: " + patient.name} extra={<a href={`/matchmaker/${patient.id}`}>Go to Manual Matchmaker</a>} style={{ backgroundColor:"#FAFAFA", marginRight: '20px', marginBottom: '10px', boxShadow: '5px 5px' }}>
            ...
            <Col span={3}>
                <Tooltip  placement="topLeft" arrowPointAtCenter disableFocusListener title="Disease Related Phenotypes can be altered by manually in edit patient page with the HPO(Human Phenotype Ontology) terminolagy.">
            ...
            <Col span={6}>
            <Tooltip placement="topLeft" arrowPointAtCenter title="Affected Gene Names are generated by taking the gene names that have high impact from the annotated VCF.">
                    <IconButton color="primary" component="span">
                        <HelpIcon fontSize="large" />
                    </IconButton>
            </Tooltip>
            ...
            {genotype_list.map(function(element, idx){
                ...
                return (
                <Tooltip placement="topLeft" arrowPointAtCenter title={"Annotation information: "+ element.anno}>
                <ListItemLink key={idx} href={"https://www.ncbi.nlm.nih.gov/gene/?term=" + element.gene_name} >
